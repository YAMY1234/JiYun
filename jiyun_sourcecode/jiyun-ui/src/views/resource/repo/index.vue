...
<!--            v-hasPermi="['resource:repo:add']"-->
          ...
          >查看</el-button>
          <!--            @click="handleDownload(scope.row)"-->
<!--          D:/同云本地共享文件夹/李洋旻资源根目录/语文资源/资源1.docx-->
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listRepo, getRepo, delRepo, addRepo, updateRepo, listRepoExcludeChild } from "@/api/resource/repo";
